...
class _HomeScreenV2State extends State<HomeScreenV2> {
  ...
  void _openNewNote() {
    ...
    // The nav bar sits BELOW the Expanded content in V2.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ── Use resizeToAvoidBottomInset: true so keyboard pushes content up ──
      ...
      body: Column(
        children: [
          ...
          // Conditionally hide when keyboard is open
