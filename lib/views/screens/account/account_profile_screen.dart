...
class _AccountProfileScreenState extends State<AccountProfileScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final pickerBorderColor =
        isDark ? const Color(0xFF2C2C2E) : const Color(0x14000000);
    final avatarOuterColor = isDark ? const Color(0xFFE2E2DF) : Colors.white;
    final avatarOuterBorder =
        isDark ? const Color(0xFF2C2C2E) : const Color(0x1F3C3C43);
    final cameraBadgeColor = isDark ? const Color(0xFF3A3A3C) : Colors.white;
    final cameraBadgeBorder =
        isDark ? const Color(0x38FFFFFF) : const Color(0x1F3C3C43);
    final saveButtonBg =
        isDark ? const Color(0xFF3A3A3C) : const Color(0xFF333333);
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration: ShapeDecoration(
                                                color: avatarOuterColor,
                                                shape: OvalBorder(
                                                  side: BorderSide(
                                                      color: avatarOuterBorder,
                                                      width: 1),
                                                ),
                                                shadows: const [
                                                  BoxShadow(
                                  ...
                                  AnimatedContainer(
                                    ...
                                    decoration: ShapeDecoration(
                                      ...
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(20),
                                        side: BorderSide(
                                            color: pickerBorderColor, width: 1),
                                      ),
                                    ),
