...
// ---------------------------------------------------------------------------
// GravityNotesNavBar
// Pixel-perfect replica of the Figma SVG (354 × 83 viewBox).
//
// SVG key measurements (all in SVG units, scale = deviceWidth / 354):
//   • Bar body   : Y 23 → 83, corner radius 20
//   • Notch left : X 129 → 154.366, curves down to Y 54.2766
//   • Notch peak : cx=177.5, cy=54.2766
//   • Notch right: X 200.634 → 226, mirrors left
//   • FAB circle : cx=177, cy=25, r=25  (sits above bar, touching at Y=0 of SVG)
//   • Icon centres (SVG x): Home≈44, Folder≈119, FAB≈177, Calendar≈236, Settings≈311
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Bar shape painter — replicates the SVG path exactly
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// FAB — white stroke circle with + icon, dark fill
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Nav icons row — 4 tappable icons with active dot indicator
// Icon SVG centres: Home≈44, Folder≈119, Calendar≈236, Settings≈311
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Icon widgets — scaled SVG paths via CustomPainter
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// Generic SVG path painter — parses a simplified SVG path string
