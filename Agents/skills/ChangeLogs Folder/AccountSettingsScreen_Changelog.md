...
---
## Summary
Migrated the AccountSettingsScreen to use the canonical AppHeaderBar widget for project-wide Liquid Glass UI consistency.
...
---
## Final Result
AccountSettingsScreen now features the standard Liquid Glass app header while preserving existing custom behavior.
