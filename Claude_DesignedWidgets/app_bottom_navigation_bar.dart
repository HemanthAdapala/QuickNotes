          ...
          child: DecoratedBox(
            decoration: BoxDecoration(
              ...
              border: Border(
                ...
                right: BorderSide(
                  color: isDark
                      ? _NavTokens.darkBorderBottom
                      : _NavTokens.lightBorderBottom,
                  width: 1.0,
                ),
                bottom: BorderSide(
                  color: isDark
...
// ─────────────────────────────────────────────────────────────────────────────
// Usage example — wire up in your Scaffold like so:
// ─────────────────────────────────────────────────────────────────────────────
...
class _ExampleState extends State<ExampleScreen> {
  ...
  static const List<NavDestination> _destinations = [
    NavDestination(
      svgAssetPath: 'assets/icons/home.svg',
      label: 'Home',
    ),
    NavDestination(
      svgAssetPath: 'assets/icons/folder-open.svg',
      label: 'Folders',
    ),
    NavDestination(
      svgAssetPath: 'assets/icons/calendar-pen.svg',
      label: 'Calendar',
    ),
    NavDestination(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      extendBody: true,            // <-- allows content to flow under the bar
      body: _buildBody(),
      bottomNavigationBar: AppBottomNavigationBar(
        destinations: _destinations,
        selectedIndex: _selectedIndex,
        onDestinationSelected: (i) => setState(() => _selectedIndex = i),
        fabSvgAssetPath: 'assets/icons/pencil.svg',
        onFabPressed: () {
